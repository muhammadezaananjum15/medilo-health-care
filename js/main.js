(function($) {
    ...
    */
    ...
    function mainNav() {
        ...
        /* Search Toggle & Click Outside Handler */
        $('.cs_search_toggle').on('click', function(e) {
            e.stopPropagation();
            $('.cs_header_search_form').toggleClass('active');
        });

        $('.cs_header_search_form').on('click', function(e) {
            e.stopPropagation();
        });

        $(document).on('click', function(e) {
            if (!$(e.target).closest('.cs_search_wrap').length) {
                $('.cs_header_search_form').removeClass('active');
            }
        });
    }
    ...
    function stickyHeader() {
        ...
        $window.on('scroll', function() {
            ...
            if (windowTop >= threshold) {
                $header.addClass('cs_gescout_sticky cs_gescout_show cs_fixed_sticky');
            } else {
                $header.removeClass('cs_gescout_sticky cs_gescout_show cs_fixed_sticky');
            }
        });
    }
